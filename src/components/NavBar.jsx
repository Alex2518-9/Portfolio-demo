...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between px-4 items-center w-full h-20 text-white bg-black fixed '>
        <div>
            <h1 className='text-5xl font-signature ml-2' >Alex</h1>
        </div>

        <ul className='hidden md:flex'>
            {/* végig megyünk a links tömbön és kiszedjük az értékeket, id-egyedi megmondja, hol tartunk, linket pedig beletesszük értékként az li-be */}
            {links.map(({id, link}) => (
